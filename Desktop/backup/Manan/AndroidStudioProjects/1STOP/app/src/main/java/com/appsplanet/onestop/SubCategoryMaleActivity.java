...
public class SubCategoryMaleActivity extends AppCompatActivity implements View.OnClickListener{

    private Button mbtnSubmit, mbtnCreateGroup;
    private ImageButton mimgbtnGoBack;
    private TextView mtxtCreateGroup, txtTitleMale;
    ...
    private CheckBox mchkboxRelationship, mchkboxNoStringsAttached, mchkboxBusinessProfessionals, mchkboxWorkoutBuddy,
            mchkboxSugarDadddy, mchkboxSugarMommy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitleMale = (TextView) findViewById(R.id.txt_titleMale);
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.txt_createANewGroup){
            ...
            txtTitleMale.setVisibility(View.VISIBLE);
            mbtnSubmit.setVisibility(View.INVISIBLE);

        }
        else if(view.getId() == R.id.btn_createGroup){
            final Dialog customDialog = new Dialog(SubCategoryMaleActivity.this);
            ...
            if(mchkboxBusinessProfessionals.isChecked()){
                Intent intent = new Intent(SubCategoryMaleActivity.this, SubcategoryBusinessProfessionalActivity.class);
                startActivity(intent);
            }
        }
        else if(view.getId() == R.id.chkbox_workoutBuddy){
            if(mchkboxWorkoutBuddy.isChecked()){
                Intent intent = new Intent(SubCategoryMaleActivity.this, SubcategoryWorkoutBuddyActivity.class);
                startActivity(intent);
            }
        }
        else if(view.getId() == R.id.chkbox_sugarDaddy) {
            if(mchkboxSugarDadddy.isChecked()){
                Intent intent = new Intent(SubCategoryMaleActivity.this, SubcategorySugarDaddymommyActivity.class);
                startActivity(intent);
            }
        }
